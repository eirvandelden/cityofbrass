  ...
  module Admin
    class StockItemsControllerTest < ActionController::TestCase
      ...
      setup do
        ...
        @item = rulebuilder_items(:stock_one)
      end
      ...
      test "should get new" do
        ...
        get :new
        assert_response :success
        assert_select "a[href='#{admin_stock_items_path}']"
      end
      ...
      test "should get options" do
        sign_in @user
        sign_in @admin
        get :options, params: { stock_item_id: @item.id }
        assert_response :success
        assert_select "a[href='#{admin_stock_items_path}']"
      ...
      test "should not destroy item" do
        ...
        assert_difference("Item.count", 0) do
          delete :destroy, params: { id: @item, stock_item: { name: @item.name } }
        end
        assert_response 403
      end
      ...
      test "should destroy item" do
        ...
        assert_redirected_to admin_stock_items_path
      end
    end
  end
end
