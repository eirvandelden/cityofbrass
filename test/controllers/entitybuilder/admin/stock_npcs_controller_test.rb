...
module Entitybuilder
  module Admin
    class StockNpcsControllerTest < ActionController::TestCase
      ...
      setup do
        ...
        @npc = entitybuilder_entities(:stock_npc_one)
      end
      ...
      test "should create npc" do
        ...
        assert_redirected_to edit_admin_stock_npc_path(assigns(:entity))
      end
      ...
      test "should not destroy npc" do
        sign_in @user
        assert_difference("Entity.count", 0) do
          delete :destroy, params: { id: @npc, stock_npc: { name: @npc.name } }
        end
        assert_response 403
      end
      ...
      test "should destroy npc" do
        ...
        assert_redirected_to admin_stock_npcs_path
      end
    end
  end
end
