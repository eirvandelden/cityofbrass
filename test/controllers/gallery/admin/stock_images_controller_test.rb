...
module Gallery
  module Admin
    class StockImagesControllerTest < ActionController::TestCase
      ...
      test "an administrator can rename a stock picture" do
        sign_in @user
        sign_in @admin
        @image.update!(file: fixture_file_upload("sample.png", "image/png"))

        patch :update, params: { id: @image, stock_image: { name: "Renamed by an administrator" } }

        assert_redirected_to edit_admin_stock_image_path(@image)
      ...
      test "should destroy image" do
        ...
        assert_redirected_to admin_stock_images_path
      end
    end
  end
end
