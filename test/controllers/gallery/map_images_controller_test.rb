...
module Gallery
  class MapImagesControllerTest < ActionController::TestCase
    ...
    test "should not create image" do
      assert_difference('Image.count', 0) do
        post :create, params: { map_image: { name: @image.name } }
      end
      assert_response 302
    end
    ...
    #    post :create, map_image: { name: @image.name }
    #  end
    ...
    test "should not destroy image" do
      sign_in @user
      assert_difference('Image.count', 0) do
        delete :destroy, params: { id: @image, map_image: { name: @image.name } }
      end
      assert_response 403
    end
    ...
    test "should destroy image" do
      ...
      assert_redirected_to map_images_path
    end
  end
end
