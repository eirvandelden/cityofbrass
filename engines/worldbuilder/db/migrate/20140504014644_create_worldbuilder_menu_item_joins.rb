class CreateWorldbuilderMenuItemJoins < ActiveRecord::Migration[4.2]
  def change
    create_table :worldbuilder_menu_item_joins, id: :string do |t|
      t.string :menu_item_id, null: false
      t.string :menu_itemable_id, null: false
