    ...
    class StockCreaturesController < EntitiesController
      ...
      def create
        ...
        respond_to do |format|
          if @entity.save
            ...
            format.html { redirect_to edit_admin_stock_creature_path(@entity), notice: @entity.name + ' was successfully created.' }
      ...
      def update
        respond_to do |format|
          if @entity.update(entity_params)
            format.html { redirect_to edit_admin_stock_creature_path(@entity) }
      ...
      def destroy
        respond_to do |format|
          if @entity.update(entity_params)
            @entity.destroy
            format.html { redirect_to admin_stock_creatures_path }
          else
