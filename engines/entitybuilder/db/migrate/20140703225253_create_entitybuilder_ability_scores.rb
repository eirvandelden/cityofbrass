class CreateEntitybuilderAbilityScores < ActiveRecord::Migration[4.2]
  def change
    create_table :entitybuilder_ability_scores, id: :string do |t|
      t.string :ability_scoreable_id
