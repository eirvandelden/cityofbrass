class CreateEntitybuilderSpecialAbilities < ActiveRecord::Migration[4.2]
  def change
    create_table :entitybuilder_special_abilities, id: :string do |t|
      t.string :special_abilityable_id
