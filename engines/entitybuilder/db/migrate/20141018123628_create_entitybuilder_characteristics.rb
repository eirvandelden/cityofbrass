class CreateEntitybuilderCharacteristics < ActiveRecord::Migration[4.2]
  def change
    create_table :entitybuilder_characteristics, id: :string do |t|
      t.string :characteristicable_id
