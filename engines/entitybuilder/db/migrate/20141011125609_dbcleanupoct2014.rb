class Dbcleanupoct2014 < ActiveRecord::Migration[4.2]
  def change
    ...
    remove_column :entitybuilder_spells, :spellable_id, :string
    ...
    remove_column :entitybuilder_items, :itemable_id, :string
